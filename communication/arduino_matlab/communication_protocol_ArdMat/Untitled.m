...
connection = serial(com_name,'BaudRate',9600);
fopen(connection);
...
while(1==1)
    ...
    recieve_variable2_Array=[recieve_variable2_Array recieve_variable1 ];
    recieve_variable3_Array=[recieve_variable3_Array recieve_variable1 ];
